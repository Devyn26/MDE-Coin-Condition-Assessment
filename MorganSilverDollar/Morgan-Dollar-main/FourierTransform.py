...
def Transform_MS67_Wheat():
    img = cv2.imread(
        'C:/Users/pm4ti/Desktop/Senior Design/Main Project Code/CoinCherrypicker/Images/ms67_wheat_reverse.jpg', 0)
...
def Transform_MS67_Memorial():
    img = cv2.imread(
        'C:/Users/pm4ti/Desktop/Senior Design/Main Project Code/CoinCherrypicker/Images/ms67_memorial_reverse.jpg', 0)
...
def Template_Overlay():
    image1 = cv2.imread('C:/Users/pm4ti/Desktop/Senior Design/Main Project Code/CoinCherrypicker/Images/template1.jpg',
                        cv2.IMREAD_GRAYSCALE)
    image2 = cv2.imread('C:/Users/pm4ti/Desktop/Senior Design/Main Project Code/CoinCherrypicker/Images/template2.jpg',
                        cv2.IMREAD_GRAYSCALE)
    image3 = cv2.imread('C:/Users/pm4ti/Desktop/Senior Design/Main Project Code/CoinCherrypicker/Images/template3.jpg',
                        cv2.IMREAD_GRAYSCALE)
...
def Numpy_VG08_Transform():
    ...
    img = cv2.imread('C:/Users/pm4ti/Desktop/Senior Design/Main Project Code/CoinCherrypicker/Images/vg08_straight.png',
                     0)
    # img = img[200:305,50:300]
    ...
    peaks, properties = find_peaks(maxima, height=(max(average_spec) - 110), prominence=4.5,
                                   distance=3.0)  # This prominence was hand taylored
...
def Numpy_MS67_Transform():
    ...
    img = cv2.imread('C:/Users/pm4ti/Desktop/Senior Design/Main Project Code/CoinCherrypicker/Images/ms67_straight.png',
                     0)
...
def Numpy_MS40_Transform():
    ...
    img = cv2.imread(
        'C:/Users/pm4ti/Desktop/Senior Design/Main Project Code/CoinCherrypicker/Images/Reverse/straight/40.jpg', 0)
    # img = img[325:575, 650:850]
    img = img[480:540, 650:840]  # note this is y, then x
...
def Overall_Fourier_to_Sheldon_Memorial():
    ...
    img = cv2.imread(
        'C:/Users/pm4ti/Desktop/Senior Design/Main Project Code/CoinCherrypicker/Images/MS63_memorial_reverse.jpg', 0)
    # img = img[325:575, 650:850]
    ...
    img = cv2.imread(
        'C:/Users/pm4ti/Desktop/Senior Design/Main Project Code/CoinCherrypicker/Images/MS69_memorial_reverse.jpg', 0)
    # img = img[325:575, 650:850]
    img = img[560:650, 300:700]  # note this is y, then x
    ...
    img = cv2.imread(
        'C:/Users/pm4ti/Desktop/Senior Design/Main Project Code/CoinCherrypicker/Images/MS70_memorial_reverse.jpg', 0)
    # img = img[325:575, 650:850]
...
def Given_Image_Name_Grade(name):
    orig_img = cv2.imread(
        'C:/Users/pm4ti/Desktop/Senior Design/Main Project Code/CoinCherrypicker/Images/Reverse/straight/' + name, 0)
    # img = img[325:575, 650:850]
    # img = img[480:540, 650:840] #note this is y, then x
...
def Overall_Derivative_Plot():
    ...
    # sheldon_scales = [45,8,10,15,20,30,35,64,20,58,12,25,40,58,63,65,68,66,67]
    # sheldon_scales = [8,10,12,15,20,20,25,30,35,40,45,58,58,63,64,65,66,67,68]
    sheldon_scales = [8, 10, 15, 20, 30, 35, 40, 45, 58, 63, 64, 66,
                      68]  # removed 65 when souldnt have, and 20 and 35 for fitting
...
def Grade_Morgan():
    ...
    orig_img = cv2.imread(
        'C:/Users/pm4ti/Desktop/Senior Design/Main Project Code/CoinCherrypicker/Images/MSD_Reverse/' + name, 0)
